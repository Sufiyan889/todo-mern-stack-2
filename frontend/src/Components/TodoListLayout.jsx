...
const TodoListLayout = () => {
  ...
  const BASE_URL =
    "https://todo-mern-stack-2-6xdj.onrender.com/api/todos/";
  ...
  const updatetodo = async(updatedtext, id)=>{
try {
    ...
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <div className="px-10 mb-8 flex-shrink-0">
        ...
        <div className="group relative flex items-center bg-[#050506] border border-white/[0.05] rounded-xl focus-within:border-red-600/30 transition-all p-1">
          ...
          <button
            onClick={post}
            className="px-8 py-3 bg-red-600 text-white rounded-lg font-bold text-[10px] tracking-[0.2em]"
          >
            Patch
          </button>
              ...
              <div className="flex items-center gap-3 opacity-60 group-hover:opacity-100 transition-all">
                ...
                <button
                  ...
                  onClick={()=>{
                    ...
                    if (updatedtext) {
                      updatetodo(updatedtext,todo._id)
                    }
                  }}
                >
